    ...
    <div class="row" >
        ...
        <div class="col-lg-10 pt-3 pb-3">
            ...
            <nav class="navbar navbar-light bg-light">
                <a class="btn btn-primary" href="/contract?action=create" role="button">Create</a>
            ...
            <table class="table" id="tableContract"  style="overflow-x:scroll; max-width: 100%; display: inline-block">
                ...
                <c:forEach items="${contracts}" var="result">
                    <tr>
                        ...
                        <td>${result.contractStartDate}</td>
                        <td>${result.contractEndDate}</td>
                        <td>${result.contractDeposit}</td>
                        <td>${result.contractTotalMoney}</td>
                        <td>${result.employeeId}</td>
                        <td>${result.customerId}</td>
                        <td>${result.serviceId}</td>
                        <td><a class="btn btn-success" href="/contract?action=edit&id=${result.contractId}" role="button">Edit</a></td>
                        <td><a onclick="ondelete('${result.contractId}','${result.employeeId}')" class="btn btn-danger"
                        ...
                        <form action="/contract">
                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                    Bạn có chắc chắn muốn xóa hợp đồng với khách hàng <input style="border: none;outline: none;color: red"
                                                                                id="nameDelete">
                                </div>
                            </div>
